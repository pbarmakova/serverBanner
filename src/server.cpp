//Класс TCP-сервера: управление соединениями, приём данных, генерация сигналов о клиентах, логика работы с сокетами.
 ...
 * Инициализирует объект TCP-сервера.
 ...
 * Создаёт новый QTcpSocket, подключает обработчики событий, добавляет клиента в список.
